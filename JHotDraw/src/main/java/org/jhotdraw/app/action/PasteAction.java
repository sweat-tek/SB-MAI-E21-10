...
/**
 * Pastes the contents of the system clipboard at the caret position. Acts on
 * the EditableComponent or JTextComponent which had the focus when the
...
public class PasteAction extends AbstractAction {
    ...
    public void actionPerformed(ActionEvent evt) {
        JComponent component = ComponentUtil.getJComponentFocusOwner();
        if (component != null) {
